...
class Solution:
    ...
    def preOrder(self, root, level, nodesMap, levels):
        ...
        # Update the rigtmost node for current level
        nodesMap[level] = root.val
    ...
    def rightSideView(self, root):
        ...
        # Dictionary to keep the "level" and the rightmost node in that level
        nodesMap = {}
        ...
        # Go over each level and put the rightmost node at that level in the output list
