...
class Solution:
    ...
    def preorderTraversal(self, root):
        ...
        while node:
           ...
           # CASE 1 - NO LEFT SUBTREE
            if not node.left:
                ...
                # Put the node value in preorder list
            ...
            # If there is a left subtree
                ...
                # Because in the Pre Order Traversal, that node will be visited at the very end of this left subtree's traversal
                temp = node.left
        ...
        # Finally, return the Pre Order Traversal result
        return preorder
